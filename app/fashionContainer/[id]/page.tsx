...
import { Watch, collections } from "@/app/colectionsFashion/data";
        ...
        <div className="max-w-5xl mx-auto">
          <div className="flex flex-col md:flex-row gap-12 items-start">
            ...
            <div className="md:w-1/2">
              ...
              <Link href={'/contactus'} className="w-45 flex items-center gap-2 bg-[#8B0000] hover:bg-[#6d0000] transition-colors duration-200 text-white text-[10px] tracking-[0.2em] uppercase font-light px-8 py-4 cursor-pointer">
                Inquire Now
                <svg className="w-3 h-3" fill="none" stroke="currentColor" strokeWidth="1.5" viewBox="0 0 24 24">
